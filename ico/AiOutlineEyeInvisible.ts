...
/**
 * OutlineEyeInvisible icon from Ant Design Icons
 * @module
 */
export function AiOutlineEyeInvisible(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineEyeInvisible;
