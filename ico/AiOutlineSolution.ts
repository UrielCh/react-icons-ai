...
/**
 * OutlineSolution icon from Ant Design Icons
 * @module
 */
export function AiOutlineSolution(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineSolution;
