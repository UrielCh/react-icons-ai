...
/**
 * OutlineEuroCircle icon from Ant Design Icons
 * @module
 */
export function AiOutlineEuroCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineEuroCircle;
