...
/**
 * FillReconciliation icon from Ant Design Icons
 * @module
 */
export function AiFillReconciliation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiFillReconciliation;
