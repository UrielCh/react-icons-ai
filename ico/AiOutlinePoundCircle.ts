...
/**
 * OutlinePoundCircle icon from Ant Design Icons
 * @module
 */
export function AiOutlinePoundCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlinePoundCircle;
