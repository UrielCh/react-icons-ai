...
/**
 * FillTwitterSquare icon from Ant Design Icons
 * @module
 */
export function AiFillTwitterSquare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiFillTwitterSquare;
