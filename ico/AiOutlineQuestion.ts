...
/**
 * OutlineQuestion icon from Ant Design Icons
 * @module
 */
export function AiOutlineQuestion(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineQuestion;
