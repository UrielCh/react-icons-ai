...
/**
 * OutlineContacts icon from Ant Design Icons
 * @module
 */
export function AiOutlineContacts(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineContacts;
