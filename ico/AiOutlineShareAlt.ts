...
/**
 * OutlineShareAlt icon from Ant Design Icons
 * @module
 */
export function AiOutlineShareAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineShareAlt;
