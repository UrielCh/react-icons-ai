...
/**
 * OutlineBranches icon from Ant Design Icons
 * @module
 */
export function AiOutlineBranches(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineBranches;
