...
/**
 * TwotoneFileMarkdown icon from Ant Design Icons
 * @module
 */
export function AiTwotoneFileMarkdown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiTwotoneFileMarkdown;
