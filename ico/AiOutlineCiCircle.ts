...
/**
 * OutlineCiCircle icon from Ant Design Icons
 * @module
 */
export function AiOutlineCiCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineCiCircle;
