...
/**
 * OutlineException icon from Ant Design Icons
 * @module
 */
export function AiOutlineException(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineException;
