...
/**
 * OutlinePullRequest icon from Ant Design Icons
 * @module
 */
export function AiOutlinePullRequest(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlinePullRequest;
