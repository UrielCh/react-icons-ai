...
/**
 * TwotoneReconciliation icon from Ant Design Icons
 * @module
 */
export function AiTwotoneReconciliation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiTwotoneReconciliation;
