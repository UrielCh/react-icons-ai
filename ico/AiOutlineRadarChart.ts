...
/**
 * OutlineRadarChart icon from Ant Design Icons
 * @module
 */
export function AiOutlineRadarChart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineRadarChart;
