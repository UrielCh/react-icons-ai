...
/**
 * OutlinePoweroff icon from Ant Design Icons
 * @module
 */
export function AiOutlinePoweroff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlinePoweroff;
