...
/**
 * OutlineReconciliation icon from Ant Design Icons
 * @module
 */
export function AiOutlineReconciliation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiOutlineReconciliation;
