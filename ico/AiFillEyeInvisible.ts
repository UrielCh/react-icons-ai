...
/**
 * FillEyeInvisible icon from Ant Design Icons
 * @module
 */
export function AiFillEyeInvisible(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default AiFillEyeInvisible;
